  ...
  return (
    <Dialog open={isWalletModalOpen} onOpenChange={closeWalletModal}>
      <DialogContent className="sm:max-w-xs">
        <DialogHeader>
          <DialogTitle className="text-base font-medium font-display">Connect Wallet</DialogTitle>
        </DialogHeader>
        
        <div className="mt-4 space-y-3">
          <Button
            variant="outline"
            className="flex items-center justify-between w-full py-2 px-3 hover:border-primary/30"
            onClick={handleConnectMetaMask}
          >
            <div className="flex items-center">
              <div className="bg-amber-500 rounded-full h-6 w-6 flex items-center justify-center">
              ...
              <span className="ml-2 text-sm">MetaMask</span>
            </div>
          ...
          >
            <div className="flex items-center">
              ...
              <span className="ml-2 text-sm">WalletConnect</span>
            </div>
            <ArrowRight className="h-3 w-3 text-muted-foreground" />
          </Button>
          ...
          >
            <div className="flex items-center">
              ...
              <span className="ml-2 text-sm">Coinbase Wallet</span>
            </div>
            <ArrowRight className="h-3 w-3 text-muted-foreground" />
          </Button>
        </div>
        ...
        <DialogFooter className="flex justify-end pt-2">
          <Button variant="ghost" size="sm" onClick={closeWalletModal} className="text-sm">
            Cancel
          </Button>
        </DialogFooter>
      </DialogContent>
