  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-xl">
        ...
        <DialogHeader>
          <DialogTitle className="text-base font-medium font-display">Earthshout</DialogTitle>
          <DialogDescription className="sr-only">Detailed view of an Earthshout message</DialogDescription>
        </DialogHeader>
            ...
            <div className="flex-grow min-w-0">
              <div className="flex items-center justify-between gap-2 mb-3">
                ...
                <div className="flex-shrink-0 bg-primary/5 border border-primary/30 px-3 py-1.5 rounded-full text-primary font-mono font-medium">
                  {message.ethBurned.toFixed(2)} ETH
                </div>
              </div>
